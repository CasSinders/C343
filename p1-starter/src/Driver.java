...
public class Driver {
	...
	public static void main(String[] args) {
		...
		// tests how many black pixels are in Davinci and Vangogh for 2bitsPerChannel
		ColorTable davinci = vectorize(mona,2);
		ColorTable vangogh = vectorize(starry,2);
		System.out.println("The number of black colors in Davinci is ");
		System.out.print(davinci.getCountAt(davinci.getIndex(Color.black)));
		System.out.println();
		System.out.println("The number of black colors in Vangogh is ");
		System.out.print(vangogh.getCountAt(vangogh.getIndex(Color.black)));
		System.out.println();
	}
}
